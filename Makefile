...
.PHONY: docker-build
docker-build:
	docker build -t cqrs-es-spec-kit-go:latest -f Dockerfile .

.PHONY: docker-build-rmu
docker-build-rmu:
	docker build -t cqrs-es-spec-kit-go-rmu:latest -f Dockerfile.rmu .
...
.PHONY: claude
claude:
	@./tools/ai-cli/run-claude.sh

.PHONY: codex
codex:
	@./tools/ai-cli/run-codex.sh

.PHONY: gemini
gemini:
	@./tools/ai-cli/run-gemini.sh
